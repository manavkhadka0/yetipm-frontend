    ...
    <main className="min-h-screen">
      ...
      <footer className="bg-white py-8 px-4">
        <div className="container mx-auto">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Lease your YETI PM through{" "}
            <Link href="https://YETIPM.com" className="text-[#447B11]">
              YETIPM.com
            </Link>{" "}
            ...
            YETI PM does not lease homes through Craigslist or other classified
            advertising services. Please note this home may be governed by a HOA
            and could require additional applications and/or fees. An account
            set-up fee will be charged on all new leases. To better serve our
            residents, YETI PM is pet-friendly with some breed restrictions and
            allows up to three pets with a monthly fee. If your home has a pool,
            a monthly fee is applied. Broker participation welcome, so please
            refer to MLS. Please contact your leasing agent for more
            information.
          </p>
